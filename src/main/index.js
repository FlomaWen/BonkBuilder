...
var BonkBuilderApp = /** @class */ (function () {
    function BonkBuilderApp() {
        this.windowManager = new window_manager_1.WindowManager();
        this.ipcHandlers = new ipc_handlers_1.IpcHandlers(this.windowManager);
    }
    /**
     * Initialise l'application
     */
    BonkBuilderApp.prototype.initialize = function () {
    ...
    return BonkBuilderApp;
}());
// Démarre l'application
var bonkApp = new BonkBuilderApp();
