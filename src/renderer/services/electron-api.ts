/**
 * API Electron pour le renderer avec nodeIntegration: true
 */

// Utiliser require pour Electron car import ne fonctionne pas bien avec le shim CommonJS
...
// Expose l'API globalement pour compatibilité
